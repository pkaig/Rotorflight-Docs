...
Additionally you can use CH11-AUX6 and CH12-AUX7 to perform in flight parameter adjustment using adjustment functions from the [Adjustments Tab](../../../configurator/tabs/adjustments.md#adjustment-functions).
...
Consult [Rotorflight Adjustments](../../../configurator/tabs/adjustments.md) for more info on how to setup the above adjustments.
