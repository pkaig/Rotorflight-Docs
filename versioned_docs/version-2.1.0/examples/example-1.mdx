...
See the [**Governor Modes**](../setup/governor.md#governor-mode) and [**Governor setup**](../setup/governor-setup.mdx) for details and examples.
...
See the [**ELRS Custom Telemetry**](../setup/elrs-custom-telemetry.mdx) on how to set it up.
