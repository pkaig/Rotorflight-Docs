...
Open Frsky Ethos Suite and connect the USB-C cable, once connected, select Lua Development tools, **NOTE: If Ethos Suite is greater than V1.5 then click LUA Library**
