...
### Configuration
Then the frequency sensor can be turned ON with the feature flag located on the [***Motors***](../Configurator/Motor.md#pwm-protocol) tab.
