...
2. Load from the supplied Diff file. **Please note:** This method may over-write some of your previously configured settings. Please check and confirm carefully.
...
<Tabs>
    ...
    <TabItem value="View Pre-set" label="View Pre-set">
        <Tabs>
            ...
            **Geometry:**	 	32mm 3D  
            **ESC Setup:**		BEC 8V2, ESC Governor Default Values  
            **Tx Settings:**	ELRS 500Hz Wide  
