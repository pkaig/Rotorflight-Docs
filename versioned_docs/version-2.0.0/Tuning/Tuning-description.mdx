...
These tuning parameters are located on the Profile tab in the [Configurator](/versioned_docs/version-2.0.0/Wiki/Configurator/Profiles.md) and could also be changed via the [LUA Scripts](/versioned_docs/version-2.0.0/Wiki/Tutorial-Setup/Lua-Scripts.mdx) or [Adjustments](/versioned_docs/version-2.0.0/Wiki/Configurator/Adjustments.md)
