...
After you've connected OpenLog/OpenLager, you have to tell Rotorflight to which UART the TX pad for the logger is connected to. You can specify that UART in the _Configuration_ tab, under _Blackbox logging_. For OpenLog, select a baud-rate of 250000 bps, for OpenLager select 2000000 bps. Click _Save_ and _Reboot_.

![OpenLager port setup](./img/openlager-serial-port.png)

After configuring OpenLog/OpenLager you can go to the *Blackbox* tab to specify what should be logged when.