...
<Tabs groupId="receiver-types">
    ...
    <TabItem value="Spectrum" label="Spectrum">

    There are a lot of different Spectrum Receivers and connections. Please review the list below for your particular receiver.
