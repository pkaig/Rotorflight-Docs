...
:::tip
For ELRS receivers, follow the [ELRS Custom Telemetry](../../setup/elrs-custom-telemetry.mdx) page for how to setup. This is new for Rotorflight 2.1 and ELRS Re-use is no longer available.  
:::
