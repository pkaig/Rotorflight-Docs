...
* It is preferable that a telemetry capable protocol be used with the [Rotorflight LUA scripts](../../Wiki/Tutorial-Setup/Lua-Scripts.mdx) to perform tuning using you radio.  
...
The stability modes (Angle, Horizon or Rescue) can be calibrated so that the heli doesn't drift much when using such a mode. This can only be done via the [accelerometer trims](../../Wiki/Tutorial-Setup/Using-Stability-Modes-example.md). 
...
:::tip
For ELRS receivers, follow the [ELRS Custom Telemetry](../../Wiki/Tutorial-Setup/ELRS%20Custom%20Telemetry.mdx) page for how to setup. This is new for Rotorflight 2.1 and ELRS Re-use is no longer available.  
:::
