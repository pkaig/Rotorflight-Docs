...
### ESC Telemetry
Check [ESC Telemetry](/docs/setup/ESC-Telemetry.md) page for detailed info. 

### Blackbox Logging
This enables a UART for an external logging device such as [OpenLager](/docs/setup/OpenLager.md).
...
This can be done either directly by the configurator or via the transmitter with [Lua](/docs/setup/Using-Stability-Modes-example.md) or Adjustments.
