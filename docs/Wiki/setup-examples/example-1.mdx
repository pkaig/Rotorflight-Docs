...
## Servo Setup
The purpose of this step is to [**setup and calibrate servos**](../Tutorial-Setup/setup-servos.mdx). On the M4 the servos are setup in the [CCPM 120 degree](../../configurator/tabs/servos.mdx#ccpm) arrangement so the servos need to be plugged in as shown below.    
...
:::info note
If your helicopter has a two stage gear train, please [**follow this guide**](../Tutorial-Setup/Two-Stage-Gear-Train-Ratios.md)
:::
