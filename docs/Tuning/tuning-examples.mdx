...
<Tabs>
    <TabItem value="OMPHOBBY M4" label="OMPHOBBY M4" default attributes={{className: tabStyles.tab}}>
    <div style={{textAlign: 'center'}}>
        <img src={jonas_m4} alt="Jonas M4" width="60%"/>
    </div>
    </TabItem>
    <TabItem value="View Pre-set" label="View Pre-set" attributes={{className: tabStyles.tab}}>
        <Tabs>
            <TabItem value="Author’s Notes" label="Author’s Notes" attributes={{className: tabStyles.tab}}>
        ...
        <TabItem value="Recommended Filters" label="Recommended Filters" attributes={{className: tabStyles.tab}}>
            ![M4 Filters](./img/jw-m4-filters.png)  
        </TabItem>
        <TabItem value="I have checked and filters are enabled and working" label="I have checked: filters are enabled and working" attributes={{className: tabStyles.tab}}>
            #### Diff all
...
<Tabs>
    <TabItem value="OMPHOBBY M4 Max" label="OMPHOBBY M4 Max" default attributes={{className: tabStyles.tab}}>
    <div style={{textAlign: 'center'}}>
