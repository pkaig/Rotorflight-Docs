...
<Tabs>
    ...
    <TabItem value="View Pre-set" label="View Pre-set">
        ...
        <TabItem value="Recommended Filters" label="Recommended Filters" default>
            ...
            The filter settings above should reduce the gyro peaks as shown below:  
            Roll axis rate gyroscope - Unfiltered:  
            ![No Filters](./img/no-filter.png)
            Roll axis rate gyroscope - Filtered:  
            ![No Filters](./img/working-filter.png)
        </TabItem>
