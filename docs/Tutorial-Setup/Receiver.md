...
Follow the following tutorial for a practical example on ELRS sensors Reuse and Setup [ELRS Telemetry Reuse WalkTrough](../Tutorial-Walkthroughs/ELRS-telemetry-reuse.md)
